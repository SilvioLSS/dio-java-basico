...
public class EstoqueProdutos {
    ...
    // Adicionar método para obter o produto mais barato
    ...
    // Adicionar método para obter o produto com maior quantidade em valor no estoque
        ...
        if (!estoqueProdutosMap.isEmpty()) {
            for (Produto p : estoqueProdutosMap.values()) {
                ...
                if (valorTotal > maiorQuantidadeValorTotal) {
                    maiorQuantidadeValorTotal = valorTotal;
